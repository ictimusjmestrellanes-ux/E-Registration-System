            ...
            <form id="newTransactionForm">
                <div class="modal-body">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="client_id" value="{{ $client->client_id ?? '' }}" readonly>
                    </div>
                    <div class="mb-3">
                        <label class="form-label">Transaction Date</label>
                        <input type="text" class="form-control" name="transaction_date" value="{{ now()->format('m/d/Y') }}" readonly>
                        <input type="hidden" name="transaction_date_hidden" value="{{ now()->format('Y-m-d') }}">
                    </div>
                    <div class="mb-3">
