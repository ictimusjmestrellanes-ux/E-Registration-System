                                                ...
                                                <table class="table table-borderless mb-0">
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td class="text-muted">{{ auth()->user()->name ?? 'User' }}</td>
                                                        </tr>
                                                        <tr>
                                                                    ...
                                                                    <div class="accordion-item border-0">
                                                                        <div class="accordion-header" id="headingThree">
                                                                            <a class="accordion-button p-2 shadow-none" data-bs-toggle="collapse" href="#collapsethree" aria-expanded="false">
                                                                                <div class="d-flex">
                                                                                    <div class="flex-shrink-0">
                                                                                        <img src="{{ asset('assets/images/avatar-5.jpg') }}" alt="" class="avatar-xs rounded-circle material-shadow">
                                                                                    </div>
                                                                                    <div class="flex-grow-1 ms-3">
                                                                    ...
                                                                    <div class="accordion-item border-0">
                                                                        <div class="accordion-header" id="headingFive">
                                                                            <a class="accordion-button p-2 shadow-none" data-bs-toggle="collapse" href="#collapseFive" aria-expanded="true">
                                                                                <div class="d-flex">
                                                                                    <div class="flex-shrink-0">
                                                                                        <img src="{{ asset('assets/images/avatar-7.jpg') }}" alt="" class="avatar-xs rounded-circle material-shadow">
                                                                                    </div>
                                                                                    <div class="flex-grow-1 ms-3">
                                                                                        <h6 class="fs-14 mb-1">
                                                                                            Lewis Arnold
                                                                            ...
                                                                            <div class="accordion-body ms-2 ps-5">
                                                                                ...
                                                                                <div class="avatar-group">
                                                                                    <a href="javascript: void(0);" class="avatar-group-item" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="" data-bs-original-title="Christi">
                                                                                        <img src="{{ asset('assets/images/avatar-4.jpg') }}" alt="" class="rounded-circle avatar-xs material-shadow">
                                                                                    </a>
                                                                                    <a href="javascript: void(0);" class="avatar-group-item" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="" data-bs-original-title="Frank Hook">
                                                                                        <img src="{{ asset('assets/images/avatar-3.jpg') }}" alt="" class="rounded-circle avatar-xs material-shadow">
                                                                                    </a>
                                                                                ...
                                                                                <div class="row mt-2">
                                                                                    <div class="col-xxl-6">
                                                                                        <div class="row border border-dashed gx-2 p-2">
                                                                                            ...
                                                                                            <!--end col-->
                                                                                            <div class="col-3">
                                                                                                <img src="{{ asset('assets/images/img-5.jpg') }}" alt="" class="img-fluid rounded material-shadow">
                                                                                            </div>
                                                                                            <!--end col-->
                                                                                            <div class="col-3">
                                                                                                <img src="{{ asset('assets/images/img-7.jpg') }}" alt="" class="img-fluid rounded material-shadow">
                                                                                            </div>
                                                                                            <!--end col-->
                                                                                            <div class="col-3">
                                                                                                <img src="{{ asset('assets/images/img-9.jpg') }}" alt="" class="img-fluid rounded material-shadow">
                                                                                            </div>
                                                                                            <!--end col-->
                                                                                        </div>
                                                                                        <!--end row-->
                                                                            ...
                                                                            <div class="accordion-body ms-2 ps-5">
                                                                                ...
                                                                                <div class="avatar-group">
                                                                                    <a href="javascript: void(0);" class="avatar-group-item material-shadow" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="" data-bs-original-title="Christi">
                                                                                        <img src="{{ asset('assets/images/avatar-4.jpg') }}" alt="" class="rounded-circle avatar-xs">
                                                                                    </a>
                                                                                    <a href="javascript: void(0);" class="avatar-group-item material-shadow" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="" data-bs-original-title="Frank Hook">
                                                                                        <img src="{{ asset('assets/images/avatar-3.jpg') }}" alt="" class="rounded-circle avatar-xs">
                                                                                    </a>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="acitivity-timeline">
                                        ...
                                        <div class="acitivity-item py-3 d-flex">
                                            <div class="flex-shrink-0">
                                                <img src="{{ asset('assets/images/avatar-6.jpg') }}" alt="" class="avatar-xs rounded-circle acitivity-avatar material-shadow">
                                            </div>
                                            <div class="flex-grow-1 ms-3">
                                        ...
                                        <div class="acitivity-item py-3 d-flex">
                                            <div class="flex-shrink-0">
                                                <img src="{{ asset('assets/images/avatar-7.jpg') }}" alt="" class="avatar-xs rounded-circle acitivity-avatar material-shadow">
                                            </div>
                                            <div class="flex-grow-1 ms-3">
                                        ...
                                        <div class="acitivity-item d-flex">
                                            <div class="flex-shrink-0">
                                                <img src="{{ asset('assets/images/avatar-8.jpg') }}" alt="" class="avatar-xs rounded-circle acitivity-avatar material-shadow">
                                            </div>
                                            <div class="flex-grow-1 ms-3">
                                                        ...
                                                        <div class="flex-grow-1">
                                                            <div class="d-flex align-items-center gap-2">
                                                                ...
                                                                <div class="avatar-group">
                                                                    ...
                                                                    <div class="avatar-group-item material-shadow">
                                                                        <div class="avatar-xs">
                                                                            <img src="{{ asset('assets/images/avatar-3.jpg') }}" alt="" class="rounded-circle img-fluid">
                                                                        </div>
                                                                    </div>
                                                                    <div class="avatar-group-item material-shadow">
                                                                        <div class="avatar-xs">
                                                        ...
                                                        <div class="flex-grow-1">
                                                            <div class="d-flex align-items-center gap-2">
                                                                ...
                                                                <div class="avatar-group">
                                                                    <div class="avatar-group-item material-shadow">
                                                                        <div class="avatar-xs">
                                                                            <img src="{{ asset('assets/images/avatar-8.jpg') }}" alt="" class="rounded-circle img-fluid">
                                                                        </div>
                                                                    </div>
                                                                    <div class="avatar-group-item material-shadow">
                                                                        <div class="avatar-xs">
                                                                            <img src="{{ asset('assets/images/avatar-7.jpg') }}" alt="" class="rounded-circle img-fluid">
                                                                        </div>
                                                                    </div>
                                                                    <div class="avatar-group-item material-shadow">
                                                                        <div class="avatar-xs">
                                                                            <img src="{{ asset('assets/images/avatar-6.jpg') }}" alt="" class="rounded-circle img-fluid">
                                                                        </div>
                                                                    </div>
                                                                    <div class="avatar-group-item material-shadow">
                                                                        <div class="avatar-xs">
                                                        ...
                                                        <div class="flex-grow-1">
                                                            <div class="d-flex align-items-center gap-2">
                                                                ...
                                                                <div class="avatar-group">
                                                                    <div class="avatar-group-item material-shadow">
                                                                        <div class="avatar-xs">
                                                                            <img src="{{ asset('assets/images/avatar-4.jpg') }}" alt="" class="rounded-circle img-fluid">
                                                                        </div>
                                                                    </div>
                                                                    <div class="avatar-group-item material-shadow">
                                                                        <div class="avatar-xs">
                                                        ...
                                                        <div class="flex-grow-1">
                                                            <div class="d-flex align-items-center gap-2">
                                                                ...
                                                                <div class="avatar-group">
                                                                    <div class="avatar-group-item material-shadow">
                                                                        <div class="avatar-xs">
                                                                            <img src="{{ asset('assets/images/avatar-2.jpg') }}" alt="" class="rounded-circle img-fluid">
                                                                        </div>
                                                                    </div>
                                                                    <div class="avatar-group-item material-shadow">
                                                                        <div class="avatar-xs">
