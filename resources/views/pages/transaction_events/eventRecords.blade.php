    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <form method="GET" action="{{ route('transaction-events.records') }}" class="d-flex flex-wrap gap-2 mb-3">
                            ...
                            @if (request('search'))
                                <a href="{{ route('transaction-events.records') }}" class="btn btn-soft-secondary btn-sm px-3">
                                    Reset
                                </a>
                            @endif
                        </form>
                            ...
                            <table class="table table-hover align-middle mb-0">
                                ...
                                <tbody>
                                    @forelse ($events as $event)
                                        <tr>
                                            <td>{{ $event->id }}</td>
                                            <td class="fw-semibold" style="width: 150px">{{ $event->transferredTransaction?->transaction_id ?? '-' }}</td>
                                            ...
                                            <td>{{ optional($event->transferred_at)->timezone('Asia/Manila')->format('M d, Y H:i:s') }}</td>
                                    ...
                                    @empty
                                        <tr>
                                            <td colspan="{{ auth()->user()?->role_name !== 'Viewer' ? 13 : 12 }}" class="text-center text-muted py-5">
