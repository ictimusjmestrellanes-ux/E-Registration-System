                    ...
                    <div class="card-body">
                        ...
                        <div class="px-4 py-3 bg-light border rounded-4 mb-4">
                            <div class="row gy-2">
                                ...
                                <div class="col-md-6 d-flex">
                                    ...
                                    <div class="fw-bold">{{ $transaction->transaction_date->format('m/d/Y') }}</div>
                                </div>
                                <div class="col-md-6 d-flex">
                                    <div class="text-uppercase text-muted small fw-semibold me-3">Client</div>
                                    <div class="fw-bold text-uppercase">{{ $clientName }}</div>
                                </div>
                                <div class="col-md-6 d-flex">
                                    <div class="text-uppercase text-muted small fw-semibold me-3">Transaction Type</div>
                                    <div class="fw-bold text-uppercase">{{ str_replace('_', ' ', $transaction->type) }}</div>
                                </div>
                                <div class="col-md-6 d-flex">
                                    <div class="text-uppercase text-muted small fw-semibold me-3">Category</div>
                                    <div class="fw-bold text-uppercase">{{ str_replace('_', ' ', $transaction->category) }}</div>
                                </div>
                                <div class="col-md-6 d-flex">
                                    <div class="text-uppercase text-muted small fw-semibold me-3">Addressed To</div>
                                    <div class="fw-bold text-uppercase">{{ str_replace('_', ' ', $transaction->addressed_to ?? '-') }}</div>
                                </div>
                            </div>
                        </div>
                        ...
                        @if ($transaction->description)
                            <div class="mb-3">
                                ...
                                <div class="border rounded-3 p-3 bg-light">{{ $transaction->description }}</div>
                            </div>
                        @endif

                        <div class="d-flex gap-2 mt-4">
                            <a href="{{ route('clients.show', $transaction->client) }}" class="btn btn-primary">View Client</a>
                            <a href="{{ route('client.list') }}" class="btn btn-outline-secondary">Back to List</a>
                        </div>
                    </div>
                </div>
            </div>
