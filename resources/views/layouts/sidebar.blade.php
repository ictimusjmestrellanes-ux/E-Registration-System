    ...
    <div class="dropdown sidebar-user m-1 rounded">
        <button type="button" class="btn material-shadow-none sidebar-user-toggle" id="sidebar-user-dropdown" data-bs-toggle="dropdown"
            ...
            <span class="d-flex align-items-center gap-2">
                ...
                @endphp
                <img class="rounded header-profile-user" src="{{ $sidebarAvatar }}"
                    alt="Header Avatar">
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse menu-dropdown show" id="sidebarDashboard">
                        <ul class="nav nav-sm flex-column">
                            <li class="nav-item">
                                <a href="{{ route('clients') }}" class="nav-link {{ set_active(['clients']) }}" data-key="t-clients">Create Clients</a>
                            </li>
                            <li class="nav-item">
                                <a href="{{ route('client.list') }}" class="nav-link {{ set_active(['client.list']) }}" data-key="t-client-list">Client List</a>
                            </li>
                            <li class="nav-item">
                                <a href="{{ route('archive.list') }}" class="nav-link {{ set_active(['archive.list']) }}" data-key="t-archive-list">Archive</a>
                            </li>
                        </ul>
                    </div>
                </li>
