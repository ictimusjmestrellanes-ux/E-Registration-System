...
Route::group(['namespace' => 'App\Http\Controllers'], function () {
    Route::middleware('auth')->group(function () {
        ...
        Route::patch('transaction-events/{event}/record/status', [TransactionEventsController::class, 'updateRecordStatus'])->name('transaction-events.records.status');
        ...
        Route::get('notifications/state', [ActivityLogsController::class, 'notificationState'])->name('notifications.state');
    });
});
