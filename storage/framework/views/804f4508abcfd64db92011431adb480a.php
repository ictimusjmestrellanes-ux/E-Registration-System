                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-center justify-content-between flex-wrap gap-3">
                            ...
                            <div class="d-flex gap-2">
                                ...
                                <span class="badge bg-danger-subtle text-danger fs-13"><?php echo e($totalDuplicates); ?>
                ...
                <div class="card">
                    <div class="card-body">
                        <ul class="nav nav-tabs mb-4" role="tablist">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" data-bs-toggle="tab" href="#likely-tab" role="tab">
                                    Likely Match
                                    <span
                                        class="badge bg-warning-subtle text-warning ms-1"><?php echo e($likelyGroups->count()); ?></span>
                                </a>
                            </li>
                            <li class="nav-item">
                        ...
                        <div class="d-flex align-items-center justify-content-between flex-wrap gap-2 mb-3">
                            ...
                            <?php if(feature_allowed('View Removed Duplicates')): ?>
                                <a href="<?php echo e(route('transaction-events.removed-duplicates')); ?>"
                        ...
                        <?php $__empty_1 = true; $__currentLoopData = $notDuplicates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $event): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <div
                                ...
                                <div>
                                    ...
                                    <span class="text-muted small ms-2">#<?php echo e($event->id); ?> &middot;
                                        <?php echo e(optional($event->birth_date)->format('M d, Y') ?? 'No birth date'); ?></span>
                                </div>
                                <?php if(auth()->user()?->role_name !== 'Viewer'): ?>
                                    <form action="<?php echo e(route('transaction-events.reset-duplicate', $event)); ?>" method="POST"
                                        class="m-0">
                                        <?php echo csrf_field(); ?>
