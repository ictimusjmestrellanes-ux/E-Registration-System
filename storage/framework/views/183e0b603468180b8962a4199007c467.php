                ...
                <ul class="navbar-nav" id="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link menu-link <?php echo e(set_active(['clients', 'client.list', 'archive.list'])); ?>" href="#sidebarClients"
                            ...
                            aria-expanded="<?php echo e(set_expanded(['clients', 'client.list', 'archive.list'])); ?>" aria-controls="sidebarClients">
                            ...
                            <ul class="nav nav-sm flex-column">
                                <li class="nav-item">
                                    <a href="#sidebarProfile"
                                        class="nav-link <?php echo e(set_active(['activity.logs', 'profile', 'settings'])); ?>"
                                        data-bs-toggle="collapse" role="button"
