        ...
        <div class="container-fluid">
            ...
            <ul class="navbar-nav" id="navbar-nav">
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse menu-dropdown <?php echo e(set_show(['activity.logs', 'profile', 'settings'])); ?>" id="sidebarPages">
                        <ul class="nav nav-sm flex-column">
                            <li class="nav-item">
                                <a href="#sidebarProfile" class="nav-link <?php echo e(set_active(['activity.logs', 'profile', 'settings'])); ?>"
                                    data-bs-toggle="collapse" role="button"
                                    aria-expanded="<?php echo e(set_expanded(['activity.logs', 'profile', 'settings'])); ?>"
                                    ...
                                    <ul class="nav nav-sm flex-column">
                                        <li class="nav-item">
                                            <a href="<?php echo e(route('activity.logs')); ?>"
                                                class="nav-link <?php echo e(set_active(['activity.logs'])); ?>"
