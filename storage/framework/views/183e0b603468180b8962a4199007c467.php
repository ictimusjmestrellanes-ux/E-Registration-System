    ...
    <div class="dropdown sidebar-user m-1 rounded">
        <button type="button" class="btn material-shadow-none" id="page-header-user-dropdown" data-bs-toggle="dropdown"
            ...
            <span class="d-flex align-items-center gap-2">
                <?php
                    $sidebarAvatar = auth()->user()?->avatar ? asset('storage/' . auth()->user()->avatar) : asset('assets/images/avatar-1.jpg');
                ?>
                <img class="rounded header-profile-user" src="<?php echo e($sidebarAvatar); ?>"
                    alt="Header Avatar">
        ...
        <div class="container-fluid">
            ...
            <ul class="navbar-nav" id="navbar-nav">
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse menu-dropdown show" id="sidebarDashboard">
                        <ul class="nav nav-sm flex-column">
                            ...
                            <li class="nav-item">
                                <a href="<?php echo e(route('archive.list')); ?>" class="nav-link <?php echo e(set_active(['archive.list'])); ?>" data-key="t-archive-list">Archive</a>
                            </li>
                        </ul>
                    </div>
                </li>
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse menu-dropdown <?php echo e(set_show(['profile', 'settings'])); ?>" id="sidebarPages">
                        <ul class="nav nav-sm flex-column">
                            <li class="nav-item">
                                <a href="#sidebarProfile" class="nav-link <?php echo e(set_active(['profile', 'settings'])); ?>"
                                    data-bs-toggle="collapse" role="button"
                                    aria-expanded="<?php echo e(set_expanded(['profile', 'settings'])); ?>"
                                    aria-controls="sidebarProfile" data-key="t-profile">Profile</a>
                                <div class="collapse menu-dropdown <?php echo e(set_show(['profile', 'settings'])); ?>"
                                    id="sidebarProfile">
                                    <ul class="nav nav-sm flex-column">
                                        <li class="nav-item">
                                            <a href="<?php echo e(route('profile')); ?>"
                                                class="nav-link <?php echo e(set_active(['profile'])); ?>"
                                                data-key="t-simple-page">Update Profile</a>
                                        </li>
                                        <li class="nav-item">
                                            <a href="<?php echo e(route('settings')); ?>"
                                                class="nav-link <?php echo e(set_active(['settings'])); ?>"
