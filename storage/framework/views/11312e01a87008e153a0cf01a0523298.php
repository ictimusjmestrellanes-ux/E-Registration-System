    ...
    <div class="container-fluid">
        <div class="profile-foreground position-relative mx-n4 mt-n4">
            <div class="profile-wid-bg profile-cover-shell">
                ...
                ?>
                <?php if($profileCover): ?>
                    <img src="<?php echo e($profileCover); ?>" alt="" class="profile-wid-img">
                <?php else: ?>
                                                ...
                                                <table class="table table-borderless mb-0">
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="text-muted"><?php echo e(auth()->user()->phone_number ?? ''); ?></td>
                                                        </tr>
                                                        <tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="text-muted"><?php echo e(auth()->user()->created_at->format('d M Y') ?? ''); ?></td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                            </div>
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\E-Reg-System\resources\views\pages\client_profile\profile.blade.php ENDPATH**/ ?>