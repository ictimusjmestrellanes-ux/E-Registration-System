                        ...
                        <div class="border rounded-4 p-3 mb-3" id="recordFiltersCard">
                            <div class="d-flex flex-wrap gap-3 align-items-start justify-content-between">
                                ...
                                <div class="d-flex flex-wrap gap-2 align-items-center">
                                    ...
                                    <a href="<?php echo e(route('transaction-events.records.export', request()->query())); ?>"
                                                    ...
                                                    <?php $__currentLoopData = $types; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        ...
                                                        <div class="form-check">
                                                            <input class="form-check-input record-type-checkbox"
                                                                type="checkbox" id="recordTypeFilter_<?php echo e($loop->index); ?>"
                                                                value="<?php echo e($type); ?>"
                                                                <?php echo e($isChecked ? 'checked' : ''); ?>>
                                                            <label class="form-check-label"
                                                                for="recordTypeFilter_<?php echo e($loop->index); ?>">
                                                                <?php echo e($type); ?>
