    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <div class="border rounded-4 p-3" id="recordFiltersCard">
                                    ...
                                    <?php $__currentLoopData = [
                                        ...
                                        'status' => 'Status',
                                                ...
                                                <div class="form-check">
                                                    ...
                                                    <label class="form-check-label" for="col-<?php echo e($key); ?>"><?php echo e($label); ?></label>
                                                </div>
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-6 col-md-6 col-xl-2">
                                        ...
                                        <input type="number" min="0" max="120" class="form-control" id="recordAgeFrom"
                                            name="age_from" placeholder="From" value="<?php echo e(request('age_from')); ?>">
                                    </div>
                                    <div class="col-6 col-md-6 col-xl-2">
                                        ...
                                        <input type="number" min="0" max="120" class="form-control" id="recordAgeTo"
                                            name="age_to" placeholder="To" value="<?php echo e(request('age_to')); ?>">
                                    </div>
                                </div>
                        ...
                        <div class="d-flex flex-wrap align-items-center gap-2 mb-2">
                            <span class="badge rounded-pill px-3 py-2" id="recordFiltersCountBadge">
                                Showing <?php echo e($events->firstItem() ?? 0); ?>–<?php echo e($events->lastItem() ?? 0); ?> of <?php echo e($events->total()); ?> record(s)
                            </span>
                        </div>

                        <div class="table-responsive">
                            <table class="table table-hover align-middle mb-0" id="eventRecordsTable">
                                ...
                                <tbody>
                                    <?php $__empty_1 = true; $__currentLoopData = $events; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $event): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <tr>
                                            ...
                                            <td data-column="transaction_id" class="fw-semibold" style="width: 150px"><?php echo e($event->transferredTransaction?->transaction_id ?? '-'); ?></td>
                                            <td data-column="full_name" class="fw-semibold"><?php echo e($event->full_name); ?></td>
                                            <td data-column="age"><?php echo e($event->age ?? '-'); ?></td>
                                            <td data-column="birth_date"><?php echo e(optional($event->birth_date)->format('M d, Y') ?? '-'); ?></td>
                                            <td data-column="contact"><?php echo e(str_replace('-', '', $event->contact_no ?? '') ?: '-'); ?></td>
                                            <td data-column="address" class="small"><?php echo e($event->address ?? '-'); ?></td>
                                            <td data-column="client_category" class="small"><?php echo e($event->client_category ?? '-'); ?></td>
                                            <td data-column="transaction_category" class="small"><?php echo e($event->transaction_category ?? '-'); ?></td>
                                            <td data-column="transaction_type" class="small"><?php echo e($event->transaction_type ?? '-'); ?></td>
                                            <td data-column="event_date" class="small"><?php echo e(optional($event->event_date)->format('M d, Y') ?? '-'); ?></td>
                                            <td data-column="transferred_at"><?php echo e(optional($event->transferred_at)->timezone('Asia/Manila')->format('M d, Y H:i:s')); ?></td>
                                    ...
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                        <tr>
                                            <td colspan="<?php echo e(auth()->user()?->role_name !== 'Viewer' ? 14 : 13); ?>" class="text-center text-muted py-5">
