...
<?php endif; ?>
                    ...
                    <div class="wizard-step d-none" data-step="2">
                        ...
                        <div class="px-4 py-3">
                            ...
                            <div class="row gx-3 align-items-center mb-3">
                                ...
                                <div class="col-md-3">
                                    <input type="text" id="wizTransactionTypeDisplay" class="form-control form-control-sm border-0 bg-light text-uppercase fw-bold" value="" readonly>
                                </div>
                    ...
                    <div class="wizard-step d-none" data-step="3">
                        ...
                        <div class="px-4 py-3">
                            <p class="text-muted mb-3 small fw-semibold">Upload the required documents. Leave unchecked and empty to skip a requirement.</p>
                            <div class="row g-3">
                                <div class="col-12 col-lg-4">
                                    <div class="p-3 border rounded-3 bg-light h-100">
                                        <label class="fw-semibold mb-2 small">1. Valid Id of Claimant with Address to Imus (Back to Back)</label>
                        ...
                        <div class="px-4 py-3">
                            <div class="table-responsive">
                                <table class="table table-sm table-bordered align-middle mb-0">
                                    <tbody>
                                        <tr>
                                            <th class="bg-light-subtle text-uppercase text-muted small fw-semibold" style="width: 220px;">Client</th>
                                        ...
                                        <tr>
                                            <th class="bg-light-subtle text-uppercase text-muted small fw-semibold">Personnel Endorsed To</th>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function goToStep(step) {
        ...
        nextBtn.textContent = step === TOTAL_STEPS ? (isEdit ? 'Review & Update' : 'Confirm Transaction') : 'Next';
    ...
    const requirementMeta = [
        { id: 'wizReqUpload1', noFileId: 'wizReqNoFile1', currentId: 'wizReqCurrent1', type: 'valid_id', label: 'Valid Id of Claimant' },
        { id: 'wizReqUpload2', noFileId: 'wizReqNoFile2', currentId: 'wizReqCurrent2', type: 'death_certificate', label: 'Registered Death Certificate' },
        { id: 'wizReqUpload3', noFileId: 'wizReqNoFile3', currentId: 'wizReqCurrent3', type: 'funeral_contract', label: 'Funeral Contract' }
    ];
    ...
    function setNoFileState(uploadId, checked) {
        ...
        document.querySelectorAll(`[data-upload-id="${uploadId}"]:not(input[type="checkbox"])`).forEach((el) => {
            el.disabled = checked;
        });
    ...
    function fillStep2() {
        ...
        if (typeDisplay) {
            typeDisplay.value = typeSelect && typeSelect.selectedIndex >= 0 ? typeSelect.options[typeSelect.selectedIndex].textContent : '-';
        }
        syncSignatory();
    }
    ...
    function fillReview() {
        ...
        document.getElementById('reviewAddressedTo').textContent = selectedText(document.getElementById('addressedToSelect'));
        ...
        document.getElementById('reviewPersonnelEndorsedTo').textContent = namedValue('personnel_endorsed_to') || 'N/A';
        document.getElementById('reviewResponsibleOffice').textContent = namedValue('responsible_office') || 'N/A';
        document.getElementById('reviewAmount').textContent = namedValue('amount') ? '₱' + Number(namedValue('amount')).toLocaleString('en-PH', { minimumFractionDigits: 2 }) : 'N/A';
        ...
        document.getElementById('reviewRequirements').innerHTML = reqItems.map(item => '<div>' + item + '</div>').join('');
        ...
        document.getElementById('reviewSubject').textContent = subjectLine + (subjectMeta.length ? ' (' + subjectMeta.join(', ') + ')' : '');
    }
    ...
    async function submitTransaction() {
        ...
        try {
            ...
            if (!res.ok || data.success === false) {
                throw new Error(data.message || 'Failed to ' + (isEdit ? 'update' : 'create') + ' the transaction.');
            }
            ...
            window.location.href = data.redirect || (clientShowUrl + '?show_transaction=' + transactionId);
        } catch (error) {
