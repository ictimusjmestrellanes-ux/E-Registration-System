<?php $__env->startSection('title', 'ERS | Archive'); ?>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex align-items-center justify-content-between flex-wrap gap-3 mb-4">
                            ...
                            <a href="<?php echo e(route('client.list')); ?>" class="btn btn-sm btn-primary">Back to Client List</a>
                        </div>
                        ...
                        <div class="d-flex justify-content-end mt-3">
                            <?php echo e($archivedClients->links('pagination::bootstrap-5')); ?>
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\E-Reg-System\resources\views/pages/archive/archive.blade.php ENDPATH**/ ?>