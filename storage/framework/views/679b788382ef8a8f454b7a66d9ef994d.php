            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="<?php echo e($editingClient ? route('clients.update', $editingClient) : route('clients.store')); ?>" method="POST" class="clients-uppercase-form">
                            <?php echo csrf_field(); ?>
                            ...
                            <div class="row g-3">
                                <div class="col-12">
                                    ...
                                    <div class="row g-3 align-items-start">
                                        <div class="col-md-auto">
                                            <img id="clientPhotoPreview" src="<?php echo e($previewImage); ?>" alt="Client Photo Preview" class="rounded-3 img-thumbnail material-shadow object-fit-cover" style="width: 250px; height: 250px;">
                                        </div>
                                        <div class="col-md">
                                ...
                                <div class="col-lg-4">
                                    ...
                                    <input type="text" class="form-control" id="firstName" name="first_name" placeholder="Enter first name" value="<?php echo e(old('first_name', $editingClient->first_name ?? '')); ?>">
                                </div>

                                <div class="col-lg-4">
                                    <label for="middleName" class="form-label">Middle Name</label>
                                    <input type="text" class="form-control" id="middleName" name="middle_name" placeholder="Enter middle name" value="<?php echo e(old('middle_name', $editingClient->middle_name ?? '')); ?>">
                                </div>

                                <div class="col-lg-4">
                                    <label for="lastName" class="form-label">Last Name</label>
                                    <input type="text" class="form-control" id="lastName" name="last_name" placeholder="Enter last name" value="<?php echo e(old('last_name', $editingClient->last_name ?? '')); ?>">
                                </div>

                                <div class="col-lg-1">
                                    <label for="age" class="form-label">Age</label>
                                    <input type="number" class="form-control" id="age" name="age" placeholder="Enter age" min="0" value="<?php echo e(old('age', $editingClient->age ?? '')); ?>">
                                </div>
                                ...
                                <div class="col-lg-3">
                                    ...
                                    <input type="text" class="form-control" id="contact" name="contact" placeholder="Enter contact number" inputmode="numeric" maxlength="11" autocomplete="off" value="<?php echo e(old('contact', $editingClient->contact ?? '')); ?>">
                                    <div id="contactError" class="text-danger small mt-1 d-none">Only numbers can be input.</div>
                                </div>

                                <div class="col-lg-4">
                                    <label for="email" class="form-label">Email</label>
                                    <input type="email" class="form-control" id="email" name="email" placeholder="Enter email" value="<?php echo e(old('email', $editingClient->email ?? '')); ?>">
                                </div>

                                <div class="col-lg-12">
                                    <label for="address" class="form-label">Address</label>
                                    <input class="form-control" id="address" name="address" rows="3" placeholder="Enter address" value="<?php echo e(old('address', $editingClient->address ?? '')); ?>">
                                </div>
                                ...
                                <div class="col-lg-4">
                                    ...
                                    <input type="text" class="form-control d-none mt-2" id="provinceManual" name="province_manual" placeholder="Enter province manually" value="<?php echo e(old('province', $editingClient->province ?? '')); ?>">
                                </div>
                                ...
                                <div class="col-lg-4">
                                    ...
                                    <input type="text" class="form-control d-none mt-2" id="cityManual" name="city_manual" placeholder="Enter city manually" value="<?php echo e(old('city', $editingClient->city ?? '')); ?>">
                                </div>
                                ...
                                <div class="col-lg-4">
                                    ...
                                    <input type="text" class="form-control d-none mt-2" id="barangayManual" name="barangay_manual" placeholder="Enter barangay manually" value="<?php echo e(old('barangay', $editingClient->barangay ?? '')); ?>">
                                </div>

                                <div class="col-12">
                                    <div class="d-flex justify-content-end gap-2 mt-2">
                                        <button type="reset" class="btn btn-soft-success">Reset</button>
                                        <button type="submit" class="btn btn-primary"><?php echo e($editingClient ? 'Update Client' : 'Save Client'); ?></button>
                                    </div>
                                </div>
                            </div>
                        </form>
