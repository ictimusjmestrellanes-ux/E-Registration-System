                        ...
                        <div class="border rounded-4 p-3 mb-3" id="clientFiltersCard">
                            <div class="d-flex flex-wrap gap-3 align-items-start justify-content-between mb-3">
                                ...
                                <div class="d-flex flex-wrap gap-2 align-items-center">
                                    ...
                                    <a href="<?php echo e(route('client.list', array_merge(request()->except('page'), ['duplicate_names' => 1]))); ?>"
                                        class="btn btn-sm <?php echo e(request()->boolean('duplicate_names') ? 'btn-warning' : 'btn-outline-warning'); ?>" style="font-size: 13px; padding: 7px;">
